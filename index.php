...
<head>
  ...
  <style>
    ...
    .login-card {
      ...
      padding: 48px 44px;
      box-shadow:
        0 0 0 1px rgba(0,229,160,.04),
        0 40px 80px rgba(0,0,0,.55),
        0 0 120px rgba(0,229,160,.05);
    }
    ...
    .btn-submit:hover {
      ...
      box-shadow: 0 8px 28px rgba(0,229,160,.35);
    }
...
<body>
  ...
  <div class="login-wrap">
    <div class="login-card">
      ...
      <!-- Formulario -->
      <form method="POST" action="<?= BASE_PATH ?>/index.php" id="loginForm" novalidate>
        ...
        <div class="input-wrap" style="margin-bottom:26px">
          ...
          <input
            ...
            required
          >
          <button type="button" class="toggle-pass" id="togglePass" title="Mostrar/ocultar contraseña">
            👁️
          </button>
        </div>
      ...
      <div class="demo-box">
        ...
        📧 Email: <code onclick="fillDemo('admin@clubfc.com','password')">admin@clubfc.com</code><br>
        🔑 Contraseña: <code onclick="fillDemo('admin@clubfc.com','password')">password</code>
